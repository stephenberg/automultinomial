...
and for $k>1$,
\begin{eqnarray}
p(z_i=k|z_{-i},\boldsymbol{\beta},\gamma)&=&\frac{\exp\{x_i^T\beta_k+\gamma\sum_{i'\sim i}I(z_{i'}=k+1)\}\}}{\exp\{\gamma\sum_{i'\sim i}I(z_{i'}=1)\}+\sum_{k=1}^{K-1}\exp\{x_i^T\beta_k+\gamma\sum_{i'\sim i}I(z_{i'}=k+1)\}}\label{p4}
\end{eqnarray}
